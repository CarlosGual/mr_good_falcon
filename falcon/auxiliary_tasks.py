...
class PeopleCounting(nn.Module):
    ...
    def forward(self, aux_loss_state, batch):
        ...
        # Return both loss and features for use in the main policy
        return dict(loss=loss, features=attn_output.squeeze(1))
...
class GuessHumanPosition(nn.Module):
    ...
    def forward(self, aux_loss_state, batch):
        ...
        # Return both loss and features for use in the main policy
        return dict(loss=final_loss, features=attn_output.squeeze(1))
